...
2. **Acquire data.** Validated and built: parcel, DEM/topography, soils, PRISM climate, wind, FEMA flood zones, building footprints, canopy extent. Source-located but not yet built into acquisition functions: watershed, ecoregions, base maps — needed before step 4 can render anything.
